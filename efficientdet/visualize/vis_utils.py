...
def draw_bounding_box_on_image_array(image,
  ...
  """
  image_pil = Image.fromarray(np.uint8(image)).convert('RGB')
  draw_bounding_box_on_image(image_pil, ymin, xmin, ymax, xmax, color, is_id,
                             thickness, display_str_list,
                             use_normalized_coordinates)
  np.copyto(image, np.array(image_pil))

def draw_bounding_box_on_image_array_custom(image,
                                     ymin,
                                     xmin,
                                     ymax,
                                     xmax,
  ...
  """
  image_pil = Image.fromarray(np.uint8(image)).convert('RGB')
  image_pil = draw_bounding_box_on_image_custom(image_pil, ymin, xmin, ymax, xmax, color,
                             thickness, display_str_list,
                             use_normalized_coordinates)

  cv2.imwrite("umm.jpg", np.array(image_pil))
...
def draw_bounding_box_on_image_custom(image,
                               ymin,
                               xmin,
                               ymax,
                               xmax,
