...
def visualize_image(image,
  ...
  label_map = label_util.get_label_map(label_map or 'coco_manual')
  # print("coco_manual", label_map)
  for class_name in classes:
      if class_name not in label_map:
          label_map[class_name] = class_name
...
def visualize_image_prediction(image,
  ...
  return visualize_image(image, boxes, classes, scores, is_id, label_map, **kwargs)
...
class ServingDriver(object):
  ...
  def visualize(self, image, prediction, is_id, **kwargs):
